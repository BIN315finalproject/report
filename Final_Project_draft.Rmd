...
The k-NN model was trained using weighted class frequencies to address imbalance. The optimal value of k, 11 was determined using 10-fold cross-validation.
...
The results shows that the genes upregulated were enriched for gene ontology categories related to immunity and muscle activity, whereas the downregulated genes showed enrichment for gene ontology categories implicated in extracellular matrix remodeling and Wnt signaling pathway.
...
These findings align with known cancer biology, emphasizing processes involved in cell growth, signaling, and regulation.
