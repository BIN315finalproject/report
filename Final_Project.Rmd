...
go_DEGs_up <- enrichGO(gene = DEGs_up, OrgDb = org.Hs.eg.db, keyType = "ENSEMBL", ont = "BP")
go_DEGs_up_df <- as.data.frame(go_DEGs_up)

go_DEGs_down <- enrichGO(gene = DEGs_down, OrgDb = org.Hs.eg.db, keyType = "ENSEMBL", ont = "BP", pvalueCutoff = 0.1)
go_DEGs_downdf <- as.data.frame(go_DEGs_down)
